...
{
	m_FileTypeInfos[".glsl"].color = ImVec4(0.1f, 0.1f, 0.5f, 1.0f);
	...
	m_FileTypeInfos[".glo"] = igfd::FilterInfosStruct(ImVec4(0.1f, 0.5f, 0.1f, 1.0f), ICON_IGFS_FILE_TYPE_PROJECT);
}
...
{
	if (ImGui::MenuItem("Default")) ApplyStyleColorsLight();
...
void ImGuiThemeHelper::ApplyStyleColorsClassic(ImGuiStyle* dst)
{
	...
	m_FileTypeInfos[".glsl"].color = ImVec4(0.1f, 0.9f, 0.5f, 1.0f); // green high
	m_FileTypeInfos[".vert"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".frag"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".tess"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".eval"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".ctrl"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".geom"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".glo"].color = ImVec4(0.9f, 0.1f, 0.9f, 1.0f); // purple high
...
void ImGuiThemeHelper::ApplyStyleColorsLight(ImGuiStyle* dst)
{
	...
	m_FileTypeInfos[".glsl"].color = ImVec4(0.1f, 0.5f, 0.1f, 1.0f); // green low
	m_FileTypeInfos[".vert"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".frag"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".tess"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".eval"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".ctrl"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".geom"].color = m_FileTypeInfos[".glsl"].color;
	m_FileTypeInfos[".glo"].color = ImVec4(0.5f, 0.1f, 0.5f, 1.0f); // purple low
